...
describe('userProfiles security rules', () => {
  ...
  test('a user should not be able to read from and to write to someone elses profile', () => {
  ...
  test('an admin should be able to read from all user profiles', () => {
    expect({uid: 'admin-user'}).can.read.path('userProfiles/some-user')
  })

  test('an admin should not be able to write to user profiles', () => {
    expect({uid: 'admin-user'}).cannot.write('something').to.path('userProfiles/some-user')
  })
})
